...
var CourseService = /** @class */ (function () {
    function CourseService(http) {
        this.http = http;
        this.apiUrl = 'https://codingthailand.com/api/get_courses.php';
        this.apiUrl2 = 'https://codingthailand.com/api/get_course_detail.php?';
    }
    ...
    CourseService.prototype.getCourseDetail = function (id) {
        var params = { course_id: id.toString() };
